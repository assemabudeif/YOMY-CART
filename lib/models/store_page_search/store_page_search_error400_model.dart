...
class StorePageSearchError400Model extends StorePageSearchModel {
  String? type;
  String? title;
  int? status;
  String? detail;
  ...
  StorePageSearchError400Model.fromJson(Map<String, dynamic> json) {
    type = json['type'];
    title = json['title'];
    status = json['status'];
    detail = json['detail'];
